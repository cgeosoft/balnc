(function(window, angular, undefined) {
   ...
   */
  module.factory(
    "Lottery", ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
      var R = Resource(
   ...
   */
  module.factory(
    "Plist", ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
      var R = Resource(
        urlBase + "/Plists/:id", {
          'id': '@id'
        }, {
